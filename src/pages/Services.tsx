    ...
    <div className="pb-20 lg:pb-0 bg-neutral-50 min-h-screen">
      ...
      <section className="relative w-full mx-auto overflow-hidden">
        ...
        <div className="hidden md:block">
          <div className="relative bg-neutral-50 overflow-hidden border-b border-gray-100">
            <div className="relative px-4 md:px-6 py-12 md:py-24 max-w-7xl mx-auto text-center">
              <div className="max-w-3xl mx-auto">
                <div className="inline-flex items-center gap-2.5 bg-[#059669]/10 px-5 py-2.5 rounded-full border border-[#059669]/20 mb-6">
                  ...
                  <span className="text-[#059669] font-semibold tracking-wider uppercase text-xs">Professional Services</span>
                </div>
                
                <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold leading-tight font-['Poppins'] mb-6 text-gray-900">
                  <span>Expert Care for Your</span>
                  <br />
                  <span className="text-[#059669]">Green Spaces</span>
                </h1>
                ...
                <div className="flex flex-wrap gap-4 justify-center">
                  <a 
                    href="#contact" 
                    className="group inline-flex items-center gap-2 px-8 py-3.5 bg-[#059669] text-white rounded font-medium text-sm hover:bg-[#006638] transition-colors shadow-lg shadow-[#059669]/20"
                  >
                  ...
                  <a 
                    href="#categories" 
                    className="inline-flex items-center gap-2 px-7 py-3.5 bg-gray-100 text-gray-900 rounded font-medium text-sm hover:bg-gray-200 transition-colors"
                  >
          ...
          {currentCategory && (
            <div className="bg-gradient-to-r from-emerald-50 to-green-50 rounded-2xl p-6 mb-8 border border-emerald-100">
              <p className="text-gray-700 text-center md:text-left">
                <span className="font-bold text-[#059669]">{currentCategory.name}:</span> {currentCategory.description}
              </p>
            </div>
          )}
